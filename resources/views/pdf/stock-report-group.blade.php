...
<head>
    <meta charset="utf-8">
    <title>Stock Report Group</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="invoice-details mt25">
                            <div class="well">
                                <span class="text-center"><b>Stock Report Group ({{ $range }})
                        ...
                        <div class="invoice-items">
                            <div class="table-responsive" style="overflow: hidden; outline: none;" tabindex="0">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach($genStocks as $stock)
                                        <tr>
                                            <td class="text-center">{{ $stock->product->name }}</td>
                                            <td class="text-center">{{ $stock->stock_total }}</td>
                                            <td class="text-center"> {{ \Carbon\Carbon::parse($stock->date)->format('m-d-Y') }}</td>
                                        </tr>
                                        @endforeach
