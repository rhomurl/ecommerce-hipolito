                        ...
                        <div class="invoice-items">
                            <div class="table-responsive" style="overflow: hidden; outline: none;" tabindex="0">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="per15 text-center">Order ID</th>
                                            <th class="per15 text-center">Payment Method</th>
                                            <th class="per15 text-center">Status</th>
                                            <th class="per15 text-center">Order Date</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $order->getPaymentModeAttribute() }}</td>
