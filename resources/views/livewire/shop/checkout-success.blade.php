<section class="text-gray-600 body-font">
    ...
    <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
      ...
      <img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="Payment success" src="{{ asset('images/payment_success.gif') }}">
      <div class="text-center lg:w-2/3 w-full">
        ...
        <div class="span-center mb-5">
            <a href="{{ route('user.overview') }}" class="btn ml-2 btn-primary">Go to My Orders</a>
