...
@endsection
    ...
    <div class="home-who-we-are-wrapper">
        ...
        <div class="container">
            ...
            <ul>
                <li>For Lipa City areas, Hipolito's Hardware and Construction Supply aims to deliver the orders within the day with a shipping flat rate of 300 php<br>while 200 php within next day.</li>
                <li>For Tanauan City areas, Hipolito's Hardware and Construction Supply aims to deliver the orders within the day with a shipping flat rate of 500 php<br>while 300 php within next day.</li>
            </ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="home-meet-btn-wrapper">
                                    <a class="home-meet-btn" href="">Contact us</a>
                                </div>
                            </div>
