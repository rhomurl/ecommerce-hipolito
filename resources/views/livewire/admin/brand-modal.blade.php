<x-modal form-action="create">
    ...
    <x-slot name="content" x-show="!isSideMenuOpen">
        <div class="px-4 py-3 mb-8 bg-white rounded-lg" x-data="{ isSideMenuOpen: false }">
            <!-- Invalid input -->
            <label class="block text-sm">
                <span class="text-gray-700">
                    Name
                </span>
                <input type="text" wire:model="name" class="block w-full mt-1 text-sm border rounded appearance-none p-2 focus:shadow-outline-blue focus:outline-none form-input" placeholder="Name">
                @error('name')
