    ...
    <x-slot name="content">
        <div class="px-4 py-3 mb-8 bg-white rounded-lg">
            ...
            <label class="block text-sm">
                ...
                <input wire:model.defer="name" type="text" required class="block w-full mt-1 text-sm border rounded appearance-none p-2 focus:shadow-outline-blue focus:outline-none form-input" placeholder="Name">
                @error('name')
